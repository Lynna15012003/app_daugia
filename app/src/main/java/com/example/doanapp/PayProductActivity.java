...
public class PayProductActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (Cart item: arrCart) {
            ...
            moneySum += pro.getPrice() * item.getQuantity();
        }
        ...
        btnOrder.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                for (Cart item: arrCart) {
                    Order order = new Order(Login.getLogin(), item.getIdProCart(), item.getQuantity(), dateTime, item.getColor(), item.getSize(), Login.getName(), Login.getPhone(), Login.getAddress(), 0);
                    db.AddOrder(order);
                }
    ...
    public void IconBackCartOnclickListener(View view) {
        onBackPressed();
    }
}
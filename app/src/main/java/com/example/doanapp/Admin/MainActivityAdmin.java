...
public class MainActivityAdmin extends AppCompatActivity {
    ...
    public void AllBrandOnclick(View view) {
        Intent intent = new Intent(MainActivityAdmin.this, AllBrandForAdmin.class);
        startActivity(intent);
    }

    public void AddBrandOnclick(View view) {
        Intent intent = new Intent(MainActivityAdmin.this, AddBrand.class);
        startActivity(intent);
    }
}